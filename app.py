...
class App:
    def __init__(self, window=tk.Tk(), window_title="Webcam Classifier Model"):
        self.window = window
    ...
    def auto_predict_toggle(self):
        self.auto_pred = not self.auto_pred
    ...
    def init_gui(self):
        ...
        self.classname_one = simpledialog.askstring("Object 1", "Enter the name of the first object:", parent=self.window)
        self.classname_two = simpledialog.askstring("Object", "Enter the name of the second object:", parent=self.window)
        ...
        self.btn_predict = tk.Button(self.window, text="Predict Object", width=50, command=self.predict)
        self.btn_predict.pack(anchor=tk.CENTER, expand=True)

        self.btn_reset = tk.Button(self.window, text="Reset", width=50, command=self.reset)
        self.btn_reset.pack(anchor=tk.CENTER, expand=True)

        self.class_label = tk.Label(self.window, text="Object Prediction")
        self.class_label.config(font=("Helvetica", 20))
    ...
    def reset(self):
        ...
        self.counters = [1, 1]
        self.model = model.Model()
        self.class_label.config(text='Object')
